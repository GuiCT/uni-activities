...
public class ExerciciosPPM {
  public static void main(String[] args) {
    try {
      ...
      redChannel.saveToFile("resources/lenaRedChannel.pgm");
      greenChannel.saveToFile("resources/lenagreenChannel.pgm");
      blueChannel.saveToFile("resources/lenablueChannel.pgm");
      ...
      lena.saveToFile("resources/lenaRedDarkened.ppm");
      ...
      lena.saveToFile("resources/lenaBlueBrightned.ppm");
      ...
      lenaRedBlueGreen.saveToFile("resources/lenaRedBlueGreen.ppm");
      // C2, C1, C3
      MatrixPPM lenaGreenRedBlue = new MatrixPPM(greenChannel, redChannel, blueChannel);
      lenaGreenRedBlue.saveToFile("resources/lenaGreenRedBlue.ppm");
      // C3, C1, C2
      MatrixPPM lenaBlueRedGreen = new MatrixPPM(blueChannel, redChannel, greenChannel);
      lenaBlueRedGreen.saveToFile("resources/lenaBlueRedGreen.ppm");
      // C3, C2, C1
      MatrixPPM lenaBlueGreenRed = new MatrixPPM(blueChannel, greenChannel, redChannel);
      lenaBlueGreenRed.saveToFile("resources/lenaBlueGreenRed.ppm");
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
